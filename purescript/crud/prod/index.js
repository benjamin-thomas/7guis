(() => {
  ...
  var filter5 = /* @__PURE__ */ filter2(ordInt);
  ...
  var TermChanged = /* @__PURE__ */ function() {
    function TermChanged2(value0) {
      this.value0 = value0;
    }
    ;
    TermChanged2.create = function(value0) {
      return new TermChanged2(value0);
    };
    return TermChanged2;
  }();
  var FirstNameChanged = /* @__PURE__ */ function() {
    function FirstNameChanged2(value0) {
      this.value0 = value0;
    }
    ;
    FirstNameChanged2.create = function(value0) {
      return new FirstNameChanged2(value0);
    };
    return FirstNameChanged2;
  }();
  var LastNameChanged = /* @__PURE__ */ function() {
    function LastNameChanged2(value0) {
      this.value0 = value0;
    }
    ;
    LastNameChanged2.create = function(value0) {
      return new LastNameChanged2(value0);
    };
    return LastNameChanged2;
  }();
  var PersonSelected = /* @__PURE__ */ function() {
    function PersonSelected2(value0) {
      this.value0 = value0;
    }
    ;
    PersonSelected2.create = function(value0) {
      return new PersonSelected2(value0);
    };
    return PersonSelected2;
  }();
  var CreateBtnClicked = /* @__PURE__ */ function() {
    function CreateBtnClicked2() {
    }
    ;
    CreateBtnClicked2.value = new CreateBtnClicked2();
    return CreateBtnClicked2;
  }();
  var UpdateBtnClicked = /* @__PURE__ */ function() {
    function UpdateBtnClicked2() {
    }
    ;
    UpdateBtnClicked2.value = new UpdateBtnClicked2();
    return UpdateBtnClicked2;
  }();
  var DeleteBtnClicked = /* @__PURE__ */ function() {
    function DeleteBtnClicked2() {
    }
    ;
    DeleteBtnClicked2.value = new DeleteBtnClicked2();
    return DeleteBtnClicked2;
  }();
  var genericAction_ = {
    to: function(x) {
      if (x instanceof Inl) {
        return new TermChanged(x.value0);
      }
      ;
      if (x instanceof Inr && x.value0 instanceof Inl) {
        return new FirstNameChanged(x.value0.value0);
      }
      ;
      if (x instanceof Inr && (x.value0 instanceof Inr && x.value0.value0 instanceof Inl)) {
        return new LastNameChanged(x.value0.value0.value0);
      }
      ;
      if (x instanceof Inr && (x.value0 instanceof Inr && (x.value0.value0 instanceof Inr && x.value0.value0.value0 instanceof Inl))) {
        return new PersonSelected(x.value0.value0.value0.value0);
      }
      ;
      ...
      if (x instanceof Inr && (x.value0 instanceof Inr && (x.value0.value0 instanceof Inr && (x.value0.value0.value0 instanceof Inr && (x.value0.value0.value0.value0 instanceof Inr && x.value0.value0.value0.value0.value0 instanceof Inr))))) {
        return DeleteBtnClicked.value;
      }
      ;
      throw new Error("Failed pattern match at Main (line 59, column 1 - line 59, column 33): " + [x.constructor.name]);
    },
    from: function(x) {
      if (x instanceof TermChanged) {
        return new Inl(x.value0);
      }
      ;
      if (x instanceof FirstNameChanged) {
        return new Inr(new Inl(x.value0));
      }
      ;
      if (x instanceof LastNameChanged) {
        return new Inr(new Inr(new Inl(x.value0)));
      }
      ;
      if (x instanceof PersonSelected) {
        return new Inr(new Inr(new Inr(new Inl(x.value0))));
      }
      ;
      if (x instanceof CreateBtnClicked) {
        return new Inr(new Inr(new Inr(new Inr(new Inl(NoArguments.value)))));
      }
      ;
      if (x instanceof UpdateBtnClicked) {
        return new Inr(new Inr(new Inr(new Inr(new Inr(new Inl(NoArguments.value))))));
      }
      ;
      if (x instanceof DeleteBtnClicked) {
  ...
  var show1 = /* @__PURE__ */ show(showAction);
  var size4 = /* @__PURE__ */ prop2(isPropInt)("size");
  var filterDb = function(term) {
    var startsWith = function(pat) {
      return function(src9) {
        return isJust(stripPrefix(toLower(pat))(toLower(src9)));
      };
    };
    return filter5(function(person) {
      return startsWith(term)(person.firstName);
    });
  };
  var component = function(dictMonadEffect) {
    var log4 = log3(monadEffectHalogenM(dictMonadEffect));
    var renderLoaded = function(db) {
      return function(form2) {
        return div_([div2([id2("form")])([div_([div2([classes(["left"])])([div2([id2("prefix-section")])([label_([text5("Filter prefix:")]), input2([value13(form2.term), onValueInput(TermChanged.create)])]), div2([id2("people")])([select3([size4(8), onValueChange(PersonSelected.create), autofocus6(true)])(map20(function(v) {
          return option([value13(show2(v.value0)), selected2(eq2(new Just(v.value0))(form2.selectedPersonId))])([text5(v.value1.firstName + (" " + v.value1.lastName))]);
        })(toUnfoldable3(db)))])]), div2([classes(["right"])])([div_([label_([text5("Name:")]), input2([value13(form2.firstName), onValueInput(FirstNameChanged.create)])]), div_([label_([text5("Surname:")]), input2([value13(form2.lastName), onValueInput(LastNameChanged.create)])])])]), div2([id2("buttons")])([button([onClick($$const(CreateBtnClicked.value))])([text5("Create")]), button([onClick($$const(UpdateBtnClicked.value))])([text5("Update")]), button([onClick($$const(DeleteBtnClicked.value))])([text5("Delete")])])])]);
      };
    };
    var render = function(state3) {
      return div_([h1_([text5("CRUD example")]), renderLoaded(filterDb(state3.form.term)(state3.data.value0))(state3.form)]);
    };
    var initialState = function(v) {
      var firstPerson = new Tuple(1, {
        firstName: "John",
        lastName: "Doe"
      });
      var initialDb = fromFoldable4([firstPerson, new Tuple(2, {
        firstName: "Jane",
        lastName: "Doe"
      }), new Tuple(3, {
        firstName: "Joe",
      ...
      return {
        data: new Loaded(initialDb),
        form: {
          term: "",
          firstName: snd(firstPerson).firstName,
          lastName: snd(firstPerson).lastName,
          selectedPersonId: new Just(fst(firstPerson))
        }
      };
    };
    var handleAction = function(action2) {
      return discard5(log4("Action: " + show1(action2)))(function() {
        if (action2 instanceof TermChanged) {
          return modify_3(function(v) {
            ...
            $146.form = function() {
              var $143 = {};
              for (var $144 in v.form) {
                if ({}.hasOwnProperty.call(v.form, $144)) {
                  $143[$144] = v["form"][$144];
                }
                ;
              }
              ;
              $143.term = action2.value0;
              return $143;
            }();
            return $146;
          });
        ...
        ;
        if (action2 instanceof FirstNameChanged) {
          return modify_3(function(v) {
            var $153 = {};
            for (var $154 in v) {
            ...
            $153.form = function() {
              var $150 = {};
              for (var $151 in v.form) {
                if ({}.hasOwnProperty.call(v.form, $151)) {
                  $150[$151] = v["form"][$151];
                }
                ;
              }
              ;
              $150.firstName = action2.value0;
              return $150;
            }();
            return $153;
          });
        ...
        ;
        if (action2 instanceof LastNameChanged) {
          return modify_3(function(v) {
            var $160 = {};
            for (var $161 in v) {
            ...
            $160.form = function() {
              var $157 = {};
              for (var $158 in v.form) {
                if ({}.hasOwnProperty.call(v.form, $158)) {
                  $157[$158] = v["form"][$158];
                }
                ;
              }
              ;
              $157.lastName = action2.value0;
              return $157;
            }();
            return $160;
          });
        ...
        ;
        if (action2 instanceof PersonSelected) {
          return modify_3(function(state3) {
            return fromMaybe(state3)(mapFlipped2(fromString(action2.value0))(function(id3) {
              var v = lookup5(id3)(state3.data.value0);
              if (v instanceof Nothing) {
                var $169 = {};
                for (var $170 in state3) {
                  if ({}.hasOwnProperty.call(state3, $170)) {
                    $169[$170] = state3[$170];
                  }
                  ;
                }
                ...
                $169.form = function() {
                  var $166 = {};
                  for (var $167 in state3.form) {
                    if ({}.hasOwnProperty.call(state3.form, $167)) {
                      $166[$167] = state3["form"][$167];
                    }
                    ;
                  }
                  ;
                  $166.selectedPersonId = Nothing.value;
                  $166.firstName = "";
                  $166.lastName = "";
                  return $166;
                }();
              ...
              if (v instanceof Just) {
                ...
                $175.form = function() {
                  var $172 = {};
                  for (var $173 in state3.form) {
                    if ({}.hasOwnProperty.call(state3.form, $173)) {
                      $172[$173] = state3["form"][$173];
                    }
                    ;
                  }
                  ;
                  $172.selectedPersonId = new Just(id3);
                  $172.firstName = v.value0.firstName;
                  $172.lastName = v.value0.lastName;
                  return $172;
                }();
                return $175;
              }
              ;
              throw new Error("Failed pattern match at Main (line 130, column 15 - line 146, column 22): " + [v.constructor.name]);
            }));
          });
        }
        ;
        if (action2 instanceof CreateBtnClicked) {
          return modify_3(function(state3) {
            var maxId = map110(function(v) {
              return v.key;
            })(findMax(state3.data.value0));
            var newId = fromMaybe(1)(map110(add2(1))(maxId));
            var newDb = insert4(newId)({
              firstName: state3.form.firstName,
              lastName: state3.form.lastName
            })(state3.data.value0);
            var $185 = {};
            for (var $186 in state3) {
              if ({}.hasOwnProperty.call(state3, $186)) {
                $185[$186] = state3[$186];
              }
              ;
            }
            ;
            $185.data = new Loaded(newDb);
            $185.form = function() {
              var $182 = {};
              for (var $183 in state3.form) {
                if ({}.hasOwnProperty.call(state3.form, $183)) {
                  $182[$183] = state3["form"][$183];
                }
                ;
              }
              ;
              $182.selectedPersonId = new Just(newId);
              return $182;
            }();
            return $185;
          });
        ...
        ;
        if (action2 instanceof UpdateBtnClicked) {
          return modify_3(function(state3) {
            if (state3.form.selectedPersonId instanceof Nothing) {
              return state3;
            }
            ;
            if (state3.form.selectedPersonId instanceof Just) {
              var newDb = insert4(state3.form.selectedPersonId.value0)({
                firstName: state3.form.firstName,
                lastName: state3.form.lastName
              })(state3.data.value0);
              var $191 = {};
              ...
              ;
              $191.data = new Loaded(newDb);
              return $191;
            }
            ;
            throw new Error("Failed pattern match at Main (line 172, column 11 - line 187, column 50): " + [state3.form.selectedPersonId.constructor.name]);
          });
        }
        ;
        if (action2 instanceof DeleteBtnClicked) {
          return modify_3(function(state3) {
            if (state3.form.selectedPersonId instanceof Nothing) {
              return state3;
            }
            ;
            if (state3.form.selectedPersonId instanceof Just) {
              var newDb = $$delete3(state3.form.selectedPersonId.value0)(state3.data.value0);
              var firstPerson = findMin(filterDb(state3.form.term)(newDb));
              if (firstPerson instanceof Nothing) {
                var $202 = {};
                ...
                ;
                $202.data = new Loaded(newDb);
                $202.form = function() {
                  var $199 = {};
                  for (var $200 in state3.form) {
                    if ({}.hasOwnProperty.call(state3.form, $200)) {
                      $199[$200] = state3["form"][$200];
                    }
                    ;
                  }
                  ;
                  $199.selectedPersonId = Nothing.value;
                  $199.firstName = "";
                  $199.lastName = "";
                  return $199;
                }();
              ...
              ;
              if (firstPerson instanceof Just) {
                var $208 = {};
                for (var $209 in state3) {
                  if ({}.hasOwnProperty.call(state3, $209)) {
                    $208[$209] = state3[$209];
                  }
                  ;
                }
                ;
                $208.data = new Loaded(newDb);
                $208.form = function() {
                  var $205 = {};
                  for (var $206 in state3.form) {
                    if ({}.hasOwnProperty.call(state3.form, $206)) {
                      $205[$206] = state3["form"][$206];
                    }
                    ;
                  }
                  ;
                  $205.selectedPersonId = new Just(firstPerson.value0.key);
                  $205.firstName = firstPerson.value0.value.firstName;
                  $205.lastName = firstPerson.value0.value.lastName;
                  return $205;
                }();
                return $208;
              }
              ;
              throw new Error("Failed pattern match at Main (line 205, column 21 - line 224, column 28): " + [firstPerson.constructor.name]);
            }
            ;
            throw new Error("Failed pattern match at Main (line 191, column 11 - line 224, column 28): " + [state3.form.selectedPersonId.constructor.name]);
          });
        }
        ;
        throw new Error("Failed pattern match at Main (line 116, column 5 - line 224, column 28): " + [action2.constructor.name]);
      });
    };
    return mkComponent({
      initialState,

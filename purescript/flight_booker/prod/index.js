(() => {
  ...
  var OkButIncompleteEntry = /* @__PURE__ */ function() {
    function OkButIncompleteEntry2() {
    }
    ;
    OkButIncompleteEntry2.value = new OkButIncompleteEntry2();
    return OkButIncompleteEntry2;
  }();
  var BadEntry = /* @__PURE__ */ function() {
    function BadEntry2(value0) {
      this.value0 = value0;
    }
    ;
    BadEntry2.create = function(value0) {
      return new BadEntry2(value0);
    };
    return BadEntry2;
  }();
  var digit = /* @__PURE__ */ function() {
    var parser_ = alt3(map6(identity(categoryFn))($$char("0")))(alt3($$char("1"))(alt3($$char("2"))(alt3($$char("3"))(alt3($$char("4"))(alt3($$char("5"))(alt3($$char("6"))(alt3($$char("7"))(alt3($$char("8"))($$char("9"))))))))));
    return withErrorMessage(parser_)("digit");
  }();
  var month = /* @__PURE__ */ bind2(/* @__PURE__ */ mapFlipped2(/* @__PURE__ */ bind2(/* @__PURE__ */ mapFlipped2(/* @__PURE__ */ mapFlipped2(/* @__PURE__ */ sequence2(/* @__PURE__ */ replicate(2)(digit)))(fromCharArray))(fromString))(/* @__PURE__ */ maybe(/* @__PURE__ */ fail("Impossible"))(pure2)))(/* @__PURE__ */ toEnum(boundedEnumMonth)))(/* @__PURE__ */ maybe(/* @__PURE__ */ fail("Not a valid month"))(pure2));
  var year = /* @__PURE__ */ bind2(/* @__PURE__ */ mapFlipped2(/* @__PURE__ */ bind2(/* @__PURE__ */ mapFlipped2(/* @__PURE__ */ mapFlipped2(/* @__PURE__ */ sequence2(/* @__PURE__ */ replicate(4)(digit)))(fromCharArray))(fromString))(/* @__PURE__ */ maybe(/* @__PURE__ */ fail("Impossible"))(pure2)))(/* @__PURE__ */ toEnum(boundedEnumYear)))(/* @__PURE__ */ maybe(/* @__PURE__ */ fail("Not a valid year"))(pure2));
  var day = /* @__PURE__ */ bindFlipped4(/* @__PURE__ */ maybe(/* @__PURE__ */ fail("Not a valid day"))(pure2))(/* @__PURE__ */ map6(/* @__PURE__ */ map1(/* @__PURE__ */ map1(/* @__PURE__ */ toEnum(boundedEnumDay))(function($63) {
    return fromJust7(fromString($63));
  }))(fromCharArray))(/* @__PURE__ */ sequence2(/* @__PURE__ */ replicate(2)(digit))));
  var parser = /* @__PURE__ */ function() {
    var mkDate = function(d) {
      return function(m) {
        return function(y) {
          return exactDate(y)(m)(d);
        };
      };
    };
    var dot = $$char(".");
    return bindFlipped4(maybe(fail("Invalid date"))(pure2))(apply2(apply2(map6(mkDate)(applyFirst2(day)(dot)))(applyFirst2(month)(dot)))(year));
  }();
  var parse$prime = function(v) {
    var isBadEntry = function(v1) {
      var strLen = length3(v.str);
      return strLen === v.expectedLength || strLen !== v1.index;
    };
    return lmap2(function(v1) {
      var $58 = isBadEntry(v1.value1);
      if ($58) {
        return new BadEntry(new ParseError(v1.value0, v1.value1));
      }
      ;
      return OkButIncompleteEntry.value;
    })(runParser(v.str)(applyFirst2(parser)(eof)));
  };
  ...
  var selectElement = function(query2) {
    return bind3(liftEffect3(bindFlipped6(composeKleisliFlipped2(function() {
  ...
  var awaitBody = /* @__PURE__ */ discard2(bindAff)(awaitLoad)(function() {
    return bind3(selectElement("body"))(function(body2) {
      return maybe(throwError3(error("Could not find body")))(pure4)(body2);
    });
  });
  ...
  var readInt = function(dictMonad) {
    ...
    return function(value14) {
      var error4 = new Left(singleton5(new TypeMismatch("Int", tagOf(value14))));
      var fromNumber2 = function() {
        var $155 = maybe(error4)(pure5);
        return function($156) {
          return $155(fromNumber($156));
        };
      }();
      return mapExceptT(map25(either($$const(error4))(fromNumber2)))(readNumber1(value14));
    };
  };
  ...
  var genericShowConstructor1 = /* @__PURE__ */ genericShowConstructor(/* @__PURE__ */ genericShowArgsArgument(showString));
  ...
  var FromField = /* @__PURE__ */ function() {
    ...
    ;
    FromField2.value = new FromField2();
    return FromField2;
  }();
  var ToField = /* @__PURE__ */ function() {
    function ToField2() {
    }
    ;
    ToField2.value = new ToField2();
    return ToField2;
  }();
  var OneWayFlight = /* @__PURE__ */ function() {
    function OneWayFlight2() {
    }
    ;
    OneWayFlight2.value = new OneWayFlight2();
    return OneWayFlight2;
  }();
  var ReturnFlight = /* @__PURE__ */ function() {
    function ReturnFlight2() {
    }
    ;
    ReturnFlight2.value = new ReturnFlight2();
  ...
  var Confirmed = /* @__PURE__ */ function() {
    function Confirmed2(value0) {
      this.value0 = value0;
    }
    ;
    Confirmed2.create = function(value0) {
      return new Confirmed2(value0);
    };
    return Confirmed2;
  }();
  var FlightOptionChanged = /* @__PURE__ */ function() {
    function FlightOptionChanged2(value0) {
      this.value0 = value0;
    }
    ;
    FlightOptionChanged2.create = function(value0) {
      return new FlightOptionChanged2(value0);
    };
    return FlightOptionChanged2;
  }();
  var FromChanged = /* @__PURE__ */ function() {
    function FromChanged2(value0) {
      this.value0 = value0;
    }
    ;
    FromChanged2.create = function(value0) {
      return new FromChanged2(value0);
    };
    return FromChanged2;
  }();
  var ToChanged = /* @__PURE__ */ function() {
    function ToChanged2(value0) {
      this.value0 = value0;
    }
    ;
    ToChanged2.create = function(value0) {
      return new ToChanged2(value0);
    };
    return ToChanged2;
  }();
  var FocusChanged = /* @__PURE__ */ function() {
    function FocusChanged2(value0) {
      this.value0 = value0;
    }
    ;
    FocusChanged2.create = function(value0) {
      return new FocusChanged2(value0);
    };
    return FocusChanged2;
  }();
  ...
  var genericFocusedField_ = {
    to: function(x) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 69, column 1 - line 69, column 39): " + [x.constructor.name]);
    },
    from: function(x) {
      if (x instanceof FromField) {
        return new Inl(NoArguments.value);
      }
      ;
      if (x instanceof ToField) {
  ...
  var showFocusedField = {
    show: /* @__PURE__ */ genericShow(genericFocusedField_)(/* @__PURE__ */ genericShowSum(/* @__PURE__ */ genericShowConstructor2({
  ...
  var genericAction_ = {
    to: function(x) {
      if (x instanceof Inl) {
        return new FlightOptionChanged(x.value0);
      }
      ;
      if (x instanceof Inr && x.value0 instanceof Inl) {
        return new FromChanged(x.value0.value0);
      }
      ;
      if (x instanceof Inr && (x.value0 instanceof Inr && x.value0.value0 instanceof Inl)) {
        return new ToChanged(x.value0.value0.value0);
      }
      ;
      if (x instanceof Inr && (x.value0 instanceof Inr && (x.value0.value0 instanceof Inr && x.value0.value0.value0 instanceof Inl))) {
        return new FocusChanged(x.value0.value0.value0.value0);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Main (line 91, column 1 - line 91, column 33): " + [x.constructor.name]);
    },
    from: function(x) {
      if (x instanceof FlightOptionChanged) {
        return new Inl(x.value0);
      }
      ;
      if (x instanceof FromChanged) {
        return new Inr(new Inl(x.value0));
      }
      ;
      if (x instanceof ToChanged) {
        return new Inr(new Inr(new Inl(x.value0)));
      }
      ;
      if (x instanceof FocusChanged) {
        return new Inr(new Inr(new Inr(new Inl(x.value0))));
      }
      ;
      if (x instanceof Submit) {
  ...
  var showAction = {
    show: /* @__PURE__ */ genericShow(genericAction_)(/* @__PURE__ */ genericShowSum(/* @__PURE__ */ genericShowConstructor(/* @__PURE__ */ genericShowArgsArgument(showInt))({
      reflectSymbol: function() {
        return "FlightOptionChanged";
      }
    ...
    }))(/* @__PURE__ */ genericShowSum(/* @__PURE__ */ genericShowConstructor(/* @__PURE__ */ genericShowArgsArgument(showFocusedField))({
      reflectSymbol: function() {
        return "FocusChanged";
      }
    }))(/* @__PURE__ */ genericShowConstructor2({
  ...
  var show3 = /* @__PURE__ */ show(showAction);
  var eqFocusedField = {
    eq: function(x) {
      return function(y) {
        ...
        ;
        if (x instanceof ToField && y instanceof ToField) {
          return true;
        }
        ;
        return false;
  ...
  var notEq2 = /* @__PURE__ */ notEq(eqFocusedField);
  var checkDate = function(str) {
    var expectedLength = length3("DD.MM.YYYY");
    return lmap3(function(v) {
      if (v instanceof OkButIncompleteEntry) {
        return "Ok (but incomplete)";
      }
      ;
      if (v instanceof BadEntry) {
        return v.value0.value0;
      }
      ;
      throw new Error("Failed pattern match at Main (line 109, column 7 - line 111, column 52): " + [v.constructor.name]);
    })(parse$prime({
      str,
      expectedLength
    }));
  };
  var checkGlobalOneWay = function(v) {
    var fromError = blush(checkDate(v.from));
    var globalErrors = mapMaybe(identity9)([fromError]);
    return {
      fromError,
      globalErrors
    };
  };
  var checkGlobalReturn = function(v) {
    var v1 = checkDate(v.to);
    var v2 = checkDate(v.from);
    if (v2 instanceof Right && v1 instanceof Right) {
      var $150 = lessThanOrEq2(v2.value0)(v1.value0);
      if ($150) {
        return {
          fromError: Nothing.value,
          toError: Nothing.value,
          globalErrors: []
        };
      }
      ;
  ...
  var component = function(dictMonadEffect) {
    ...
    var renderEditing = function(state3) {
      var submitBtn = function(v) {
        return button([onClick(function(v1) {
          return Submit.value;
        }), disabled10(!$$null(v.globalErrors))])([text5("Book")]);
      };
      var renderError = function(err) {
        return span4([style("color:lightgrey; margin-left:5px;")])([text5(err)]);
      };
      var renderGlobalErrors = function(v) {
        var $158 = $$null(v.globalErrors);
        if ($158) {
          return div2([style("color:green")])([text5("All good \u2713")]);
        }
        ;
        return div_(map24(renderError)(v.globalErrors));
      };
      var flightOptionInput = select3([onSelectedIndexChange(FlightOptionChanged.create)])([option_([text5("One Way")]), option_([text5("Return")])]);
      var errorStyle = function(v) {
        var len = length3(v.value);
        return style(function() {
          var $161 = len > 1 && (len >= 10 || notEq2(state3.focusedField)(v.self));
          if ($161) {
      ...
      var fromInput = function(v) {
        var mkInput = function(style3) {
          return input2(mapMaybe(identity9)([new Just(placeholder3("From")), new Just(value13(state3.from)), new Just(onValueInput(FromChanged.create)), new Just(onFocus(function(v1) {
            return new FocusChanged(FromField.value);
          })), style3]));
        };
        return div_(function() {
          if (v.fromError instanceof Nothing) {
            return [mkInput(Nothing.value)];
          }
          ;
          if (v.fromError instanceof Just) {
            return [mkInput(new Just(errorStyle({
              value: state3.from,
              self: FromField.value
            }))), renderError(v.fromError.value0)];
          }
          ;
          throw new Error("Failed pattern match at Main (line 238, column 15 - line 248, column 20): " + [v.fromError.constructor.name]);
        }());
      };
      var toInput = function(v) {
        var mkInput = function(style3) {
          return input2(mapMaybe(identity9)([new Just(placeholder3("To")), new Just(value13(state3.to)), new Just(onValueInput(ToChanged.create)), new Just(onFocus(function(v1) {
            return new FocusChanged(ToField.value);
          })), new Just(disabled10(v.disabled)), style3]));
        };
        return div_(function() {
          if (v.toError instanceof Nothing) {
            return [mkInput(Nothing.value)];
          }
          ;
          if (v.toError instanceof Just) {
            return [mkInput(new Just(errorStyle({
              value: state3.to,
              self: ToField.value
            }))), renderError(v.toError.value0)];
          }
          ;
          throw new Error("Failed pattern match at Main (line 267, column 13 - line 278, column 18): " + [v.toError.constructor.name]);
        }());
      };
      return div_([h1_([text5("Flight Booker")]), code_([text5("Valid date format is: dd.mm.yyyy")]), div2([style("margin-top: 20px")])(function() {
        if (state3.flightOption instanceof OneWayFlight) {
          var v = checkGlobalOneWay({
            from: state3.from
          });
          return [flightOptionInput, fromInput({
            fromError: v.fromError
          }), toInput({
            disabled: true,
            toError: Nothing.value
          }), renderGlobalErrors({
            globalErrors: v.globalErrors
          }), submitBtn({
            globalErrors: v.globalErrors
          })];
        }
        ;
        if (state3.flightOption instanceof ReturnFlight) {
          var v = checkGlobalReturn({
            from: state3.from,
            to: state3.to
          });
          return [flightOptionInput, fromInput({
        ...
        ;
        throw new Error("Failed pattern match at Main (line 299, column 15 - line 320, column 22): " + [state3.flightOption.constructor.name]);
      }())]);
    };
    var render = function(v) {
      if (v instanceof Editing) {
        return renderEditing(v.value0);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Main (line 325, column 12 - line 327, column 33): " + [v.constructor.name]);
    };
    var initialState = function(v) {
      return new Editing({
        flightOption: OneWayFlight.value,
        from: "",
        to: "",
        focusedField: FromField.value
      });
    };
    var handleEditing = function(edit) {
      return function(v) {
        if (v instanceof FlightOptionChanged) {
          return new Editing({
            from: edit.from,
            to: edit.to,
            focusedField: edit.focusedField,
            flightOption: function() {
              var $185 = v.value0 === 1;
              if ($185) {
                return ReturnFlight.value;
              }
              ;
              return OneWayFlight.value;
            }()
          });
        }
        ;
        if (v instanceof FromChanged) {
          return new Editing({
            flightOption: edit.flightOption,
            to: edit.to,
            from: v.value0,
            focusedField: FromField.value
          });
        ...
        ;
        if (v instanceof ToChanged) {
          return new Editing({
            flightOption: edit.flightOption,
            from: edit.from,
            to: v.value0,
            focusedField: ToField.value
          });
        }
        ;
        if (v instanceof FocusChanged) {
          return new Editing({
            flightOption: edit.flightOption,
            from: edit.from,
            to: edit.to,
            focusedField: v.value0
          });
        }
        ;
        if (v instanceof Submit) {
          if (edit.flightOption instanceof OneWayFlight) {
            return new Confirmed("Your one-way flight has been booked");
          }
          ;
          if (edit.flightOption instanceof ReturnFlight) {
            return new Confirmed("Your return flight has been booked");
          }
          ;
          throw new Error("Failed pattern match at Main (line 184, column 7 - line 186, column 71): " + [edit.flightOption.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at Main (line 170, column 24 - line 186, column 71): " + [v.constructor.name]);
      };
    };
    var handleAction = function(action2) {
      return discard5(log4("action" + (" : " + show3(action2))))(function() {
        return modify_3(function(v) {
          if (v instanceof Editing) {
            return handleEditing(v.value0)(action2);
          }
          ;
          if (v instanceof Confirmed) {
            return new Confirmed(v.value0);
          }
          ;
          throw new Error("Failed pattern match at Main (line 191, column 15 - line 195, column 37): " + [v.constructor.name]);
        });
      });
    };
    return mkComponent({

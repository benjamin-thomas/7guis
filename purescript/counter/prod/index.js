(() => {
  ...
  var component = /* @__PURE__ */ function() {
    var render = function(state3) {
      return div2([id2("app")])([h1_([text5("Counter example")]), div2([class_("control")])([input([value13(show2(state3.counter)), disabled10(true)]), button([onClick(function(v) {
        return Inc.value;
      })])([text5("count")])])]);
    };
    ...
    var handleAction = function(v) {
      ...
      if (v instanceof Dec) {
        return modify_3(function(state3) {
          var $16 = {};
          for (var $17 in state3) {
            if ({}.hasOwnProperty.call(state3, $17)) {
              $16[$17] = state3[$17];
            }
            ;
          }
          ;
          $16.counter = state3.counter - 1 | 0;
          return $16;
        });
      }
      ;
      throw new Error("Failed pattern match at Main (line 36, column 18 - line 38, column 69): " + [v.constructor.name]);
    };
    return mkComponent({
      initialState,
      "eval": mkEval({

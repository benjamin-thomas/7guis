(() => {
  ...
  var tail = function(v2) {
    ...
    ;
    throw new Error("Failed pattern match at Data.List (line 245, column 1 - line 245, column 43): " + [v2.constructor.name]);
  };
        ...
        function $tco_loop(v2) {
          ...
          if (v2 instanceof Cons) {
            ...
            if (v2.value0 instanceof Two) {
              $copy_v = new Cons(v2.value0.value0, new Cons(singleton3(v2.value0.value1)(v2.value0.value2), new Cons(v2.value0.value3, v2.value1)));
              return;
            }
            ;
            if (v2.value0 instanceof Three) {
              $copy_v = new Cons(v2.value0.value0, new Cons(singleton3(v2.value0.value1)(v2.value0.value2), new Cons(v2.value0.value3, new Cons(singleton3(v2.value0.value4)(v2.value0.value5), new Cons(v2.value0.value6, v2.value1)))));
              return;
            }
            ;
    ...
    var go2 = function($copy_v) {
      return function($copy_v1) {
        ...
        function $tco_loop(v2, v1) {
          ...
          ;
          throw new Error("Failed pattern match at Data.Map.Internal (line 330, column 5 - line 330, column 22): " + [v2.constructor.name, v1.constructor.name]);
        }
        ;
        while (!$tco_done) {
          $tco_result = $tco_loop($tco_var_v, $copy_v1);
  ...
  var bindExceptT = function(dictMonad) {
    ...
    return {
      bind: function(v2) {
        return function(k) {
          return bind5(v2)(either(function($187) {
    ...
    return function(v2) {
      ...
      if (v2 instanceof Query) {
        return unCoyoneda(function(g) {
          var $45 = map10(maybe(v2.value1(unit))(g));
          return function($46) {
  ...
  var cy = /* @__PURE__ */ function() {
    var $117 = attr2("cy");
    return function($118) {
      return $117(show3($118));
    };
  }();
  var cx = /* @__PURE__ */ function() {
    var $119 = attr2("cx");
    return function($120) {
      return $119(show3($120));
    };
  }();
  ...
  var evalQ = function(render) {
    return function(ref2) {
      return function(q3) {
        return bind12(liftEffect4(read(ref2)))(function(v2) {
          return evalM(render)(ref2)(v2["component"]["eval"](new Query(map14(Just.create)(liftCoyoneda(q3)), $$const(Nothing.value))));
        });
      };
    };
  };
  ...
  var MouseMoved = /* @__PURE__ */ function() {
    function MouseMoved2(value0) {
      this.value0 = value0;
    }
    ;
    MouseMoved2.create = function(value0) {
      return new MouseMoved2(value0);
    };
    return MouseMoved2;
  }();
  var DrawingAreaClicked = /* @__PURE__ */ function() {
    function DrawingAreaClicked2() {
    }
    ;
    DrawingAreaClicked2.value = new DrawingAreaClicked2();
    return DrawingAreaClicked2;
  }();
  var MouseRightBtnClicked = /* @__PURE__ */ function() {
    function MouseRightBtnClicked2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    MouseRightBtnClicked2.create = function(value0) {
      return function(value1) {
        return new MouseRightBtnClicked2(value0, value1);
      };
    };
    return MouseRightBtnClicked2;
  }();
  var CircleRadiusChanged = /* @__PURE__ */ function() {
    function CircleRadiusChanged2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    CircleRadiusChanged2.create = function(value0) {
      return function(value1) {
        return new CircleRadiusChanged2(value0, value1);
      };
    };
    return CircleRadiusChanged2;
  }();
  var MouseReleased = /* @__PURE__ */ function() {
    function MouseReleased2() {
    }
    ;
    MouseReleased2.value = new MouseReleased2();
    return MouseReleased2;
  }();
  var UndoBtnClicked = /* @__PURE__ */ function() {
    function UndoBtnClicked2() {
    }
    ;
    UndoBtnClicked2.value = new UndoBtnClicked2();
    return UndoBtnClicked2;
  }();
  var RedoBtnClicked = /* @__PURE__ */ function() {
    function RedoBtnClicked2() {
    }
    ;
    RedoBtnClicked2.value = new RedoBtnClicked2();
    return RedoBtnClicked2;
  }();
  var onContextMenu = /* @__PURE__ */ handler2("contextmenu");
  var distFromCenter = function(v2) {
    return function(v1) {
  ...
  var component = function(dictMonadEffect) {
    ...
    var render = function(state3) {
      var circleColor = function(circle2) {
        var dist = distFromCenter(new Tuple(circle2.x, circle2.y))(new Tuple(toNumber(state3.mouseX), toNumber(state3.mouseY)));
        return new Named(function() {
          var $44 = dist < circle2.r;
          if ($44) {
            return "lightgrey";
          }
          ;
      ...
      var mkCircle = function(v2) {
        return circle([fill(circleColor(v2.value1)), stroke(new Named("black")), cx(v2.value1.x), cy(v2.value1.y), r(v2.value1.r), onContextMenu(MouseRightBtnClicked.create({
          circleId: v2.value0,
          circle: v2.value1
        }))]);
      };
      return div2([id2("container")])([h1_([text5("Circle drawer")]), p_([text5("Right click to change the diameter")]), div2([id2("buttons")])([button([onClick($$const(UndoBtnClicked.value))])([text5("Undo")]), button([onClick($$const(RedoBtnClicked.value))])([text5("Redo")])]), svg([onMouseMove(MouseMoved.create), onClick($$const(DrawingAreaClicked.value)), style("background:white")])(map19(mkCircle)(toUnfoldable3(state3.history.current))), function() {
        if (state3.showAdjustDialog instanceof Nothing) {
          return text5("");
        }
        ;
        if (state3.showAdjustDialog instanceof Just) {
          var conv = function(n) {
            return fromMaybe("?")(mapFlipped2(fromNumber(n))(toStringAs(decimal)));
          };
          var coords2 = "(" + (conv(state3.showAdjustDialog.value0.circle.x) + (", " + (conv(state3.showAdjustDialog.value0.circle.y) + ")")));
          return div2([id2("adjust-dialog"), style("top:" + (conv(state3.showAdjustDialog.value0.circle.y) + "px"))])([div_([text5("Adjust diameter of circle at " + (coords2 + "."))]), input2([type_19(InputRange.value), onValueInput(CircleRadiusChanged.create({
            circleId: state3.showAdjustDialog.value0.circleId
          })), onMouseUp($$const(MouseReleased.value)), min5(5), max6(100), value13(toStringAs(decimal)(fromJust5(fromNumber(state3.showAdjustDialog.value0.circle.r))))])]);
        }
        ;
        throw new Error("Failed pattern match at Main (line 232, column 11 - line 256, column 20): " + [state3.showAdjustDialog.constructor.name]);
      }()]);
    };
    var initialState = function(v2) {
      return {
        ...
        showAdjustDialog: Nothing.value,
        defaultCircleRadius: 20
      };
    };
    var handleAction = function(v2) {
      if (v2 instanceof MouseMoved) {
        return modify_3(function(state3) {
          ...
          ;
          $53.mouseX = offsetX(v2.value0);
          $53.mouseY = offsetY(v2.value0);
          return $53;
        });
      }
      ;
      if (v2 instanceof DrawingAreaClicked) {
        return modify_3(function(state3) {
          var nextId = fromMaybe(1)(mapFlipped2(mapFlipped2(findMax(state3.history.current))(function(v1) {
            return v1.key;
          }))(add1(1)));
          var newCircles = insert4(nextId)({
            x: toNumber(state3.mouseX),
            y: toNumber(state3.mouseY),
            r: state3.defaultCircleRadius
          })(state3.history.current);
          var $60 = {};
          ...
          $60.history = function() {
            var $57 = {};
            for (var $58 in state3.history) {
              if ({}.hasOwnProperty.call(state3.history, $58)) {
                $57[$58] = state3["history"][$58];
              }
              ;
            }
            ;
            $57.past = new Cons(state3.history.current, state3.history.past);
            $57.current = newCircles;
            return $57;
          }();
          return $60;
        });
      ...
      ;
      if (v2 instanceof MouseRightBtnClicked) {
        return discard5(liftEffect7(preventDefault(v2.value1)))(function() {
          return modify_3(function(state3) {
            var $66 = {};
            ...
            ;
            $66.showAdjustDialog = new Just(v2.value0);
            $66.history = function() {
              var $63 = {};
              for (var $64 in state3.history) {
                if ({}.hasOwnProperty.call(state3.history, $64)) {
                  $63[$64] = state3["history"][$64];
                }
                ;
              }
              ;
              $63.past = new Cons(state3.history.current, state3.history.past);
              return $63;
            }();
            return $66;
          });
      ...
      ;
      if (v2 instanceof CircleRadiusChanged) {
        return modify_3(function(state3) {
          var v1 = lookup5(v2.value0.circleId)(state3.history.current);
          if (v1 instanceof Nothing) {
            return state3;
          }
          ;
          if (v1 instanceof Just) {
            var r2 = fromJust5(fromString(v2.value1));
            var newCircle = {
              x: v1.value0.x,
              y: v1.value0.y,
              r: r2
            };
            var current = insert4(v2.value0.circleId)(newCircle)(state3.history.current);
            var $75 = {};
            ...
            $75.history = function() {
              var $72 = {};
              for (var $73 in state3.history) {
                if ({}.hasOwnProperty.call(state3.history, $73)) {
                  $72[$73] = state3["history"][$73];
                }
                ;
              }
              ;
          ...
          ;
          throw new Error("Failed pattern match at Main (line 140, column 9 - line 151, column 54): " + [v1.constructor.name]);
        });
      }
      ;
      if (v2 instanceof MouseReleased) {
        return modify_3(function(state3) {
          var $82 = {};
          ...
          ;
          $82.showAdjustDialog = Nothing.value;
          return $82;
        });
      }
      ;
      if (v2 instanceof UndoBtnClicked) {
        return modify_3(function(state3) {
          var past = fromMaybe(Nil.value)(tail(state3.history.past));
          var future = new Cons(state3.history.current, state3.history.future);
          var current = fromMaybe(state3.history.current)(head(state3.history.past));
          var $88 = {};
          ...
          $88.history = function() {
            var $85 = {};
            for (var $86 in state3.history) {
              if ({}.hasOwnProperty.call(state3.history, $86)) {
                $85[$86] = state3["history"][$86];
              }
              ;
            }
            ;
      ...
      ;
      if (v2 instanceof RedoBtnClicked) {
        return modify_3(function(state3) {
          var past = new Cons(state3.history.current, state3.history.past);
          var future = fromMaybe(Nil.value)(tail(state3.history.future));
          var current = fromMaybe(state3.history.current)(head(state3.history.future));
          var $94 = {};
          ...
          $94.history = function() {
            var $91 = {};
            for (var $92 in state3.history) {
              if ({}.hasOwnProperty.call(state3.history, $92)) {
                $91[$92] = state3["history"][$92];
              }
              ;
            }
            ;
      ...
      ;
      throw new Error("Failed pattern match at Main (line 104, column 18 - line 196, column 14): " + [v2.constructor.name]);
    };
    return mkComponent({
      initialState,
      "eval": mkEval({
